...
namespace beamTableformPlacerDG {
	...
	enum	idxItems_1_forBeamPlacer {
		IMAGE_BEAM_SECTION_NO_SLAB_NO_INSUL = 3,
		IMAGE_BEAM_SECTION_NO_SLAB_WITH_INSUL,
		IMAGE_BEAM_SECTION_SAME_SLAB_NO_INSUL,
		IMAGE_BEAM_SECTION_SAME_SLAB_WITH_INSUL,
		IMAGE_BEAM_SECTION_LEFT_THK_RIGHT_THIN_SLAB_NO_INSUL,
		IMAGE_BEAM_SECTION_LEFT_THK_RIGHT_THIN_SLAB_WITH_INSUL,
		IMAGE_BEAM_SECTION_LEFT_THIN_RIGHT_THK_SLAB_NO_INSUL,
		IMAGE_BEAM_SECTION_LEFT_THIN_RIGHT_THK_SLAB_WITH_INSUL,
		...
		LABEL_MORPH_HEIGHT_LEFT,
		EDITCONTROL_MORPH_HEIGHT_LEFT,
		LABEL_MORPH_HEIGHT_RIGHT,
		EDITCONTROL_MORPH_HEIGHT_RIGHT,

		LABEL_SLAB_THK_LEFT,
		EDITCONTROL_SLAB_THK_LEFT,
		LABEL_SLAB_THK_RIGHT,
		EDITCONTROL_SLAB_THK_RIGHT,

		CHECKBOX_INSULATION,
		LABEL_INSUL_THK_LEFT,
		EDITCONTROL_INSUL_THK_LEFT,
		LABEL_INSUL_THK_BOTTOM,
		EDITCONTROL_INSUL_THK_BOTTOM,
		LABEL_INSUL_THK_RIGHT,
		EDITCONTROL_INSUL_THK_RIGHT,

		LABEL_REST_LEFT,
		CHECKBOX_TIMBER_LEFT,
		CHECKBOX_T_FORM_LEFT,
		CHECKBOX_FILLER_LEFT,
		CHECKBOX_B_FORM_LEFT,

		EDITCONTROL_REST_LEFT,
		EDITCONTROL_TIMBER_LEFT,
		POPUP_T_FORM_LEFT,
		EDITCONTROL_FILLER_LEFT,
		POPUP_B_FORM_LEFT,

		EDITCONTROL_REST_RIGHT,
		EDITCONTROL_TIMBER_RIGHT,
		POPUP_T_FORM_RIGHT,
		EDITCONTROL_FILLER_RIGHT,
		POPUP_B_FORM_RIGHT,

		LABEL_REST_RIGHT,
		CHECKBOX_TIMBER_RIGHT,
		CHECKBOX_T_FORM_RIGHT,
		CHECKBOX_FILLER_RIGHT,
		CHECKBOX_B_FORM_RIGHT,
...
public:
	...
	short	EDITCONTROL_WIDTH_EUROFORM[50];
